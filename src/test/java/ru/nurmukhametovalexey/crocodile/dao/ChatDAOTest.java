...
class ChatDAOTest {
    ...
    void getChatByGameUUID() {
        ...
        List<Chat> result = chatDAO.getChatByGameUUID("uuid2");
        assertThat(result).usingRecursiveComparison().isEqualTo(expected);
    }

    @Test
    void getChatByGameUUID_IfNoChat_ShouldReturnEmptyList() {
        List<Chat> result = chatDAO.getChatByGameUUID("no such uuid");
    ...
    void getLastMessageByGameUUID() {
        ...
        Chat result = chatDAO.getLastMessageByGameUUID("uuid2");
        assertThat(result).usingRecursiveComparison().isEqualTo(expected);
    }

    @Test
    void getLastMessageByGameUUID_IfNoChat_ShouldReturnNull() {
        Chat result = chatDAO.getLastMessageByGameUUID("no such uuid");
    ...
    void save() {
        ...
        Boolean result = chatDAO.save(chatToSave);
        assertThat(result).isTrue();
        Chat savedChat = chatDAO.getLastMessageByGameUUID(chatToSave.getGameUUID());
